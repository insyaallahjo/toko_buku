...
class Load_model extends CI_Model {
	...
	public function buku($post) {
		...
		$data_table = function() use ($post) {
			...
			$d = array(
				"table" => "buku",
				"columns" => ["idbuku", "judul", "noisbn", "stok", "penulis", "tahun"],
			...
			foreach($this->dt->get_data() as $data) {
				...
				<a href=\"javascript:void(0)\" class=\"btn btn-warning btn-sm\" data-action=\"edit\" id=\"".$data['idbuku']."\" >Edit</a> 
				<a href=\"javascript:void(0)\" class=\"btn btn-danger btn-sm\" data-action=\"hapus\" id=\"".$data['idbuku']."\" >Hapus</a> ";
